...
export default function Index() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-civic-blue-50 via-white to-civic-green-50">
      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-civic-blue-100 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-civic-blue-900">CivicConnect</h1>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <p className="text-xl text-civic-blue-700 mb-8 max-w-3xl mx-auto leading-relaxed">
            Connect your community with local government through our comprehensive civic issue reporting platform. 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <Card className="border-civic-blue-200 bg-white/50 backdrop-blur-sm">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-civic-blue-600 mb-2">2,847</div>
                <div className="text-sm text-civic-blue-700">Issues Resolved</div>
              </CardContent>
            </Card>
            <Card className="border-civic-green-200 bg-white/50 backdrop-blur-sm">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-civic-green-600 mb-2">15,432</div>
                <div className="text-sm text-civic-green-700">Active Citizens</div>
              </CardContent>
            </Card>
            <Card className="border-civic-orange-200 bg-white/50 backdrop-blur-sm">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-civic-orange-600 mb-2">12</div>
                <div className="text-sm text-civic-orange-700">Partner Cities</div>
              </CardContent>
            </Card>
            <Card className="border-civic-blue-200 bg-white/50 backdrop-blur-sm">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-civic-blue-600 mb-2">94%</div>
                <div className="text-sm text-civic-blue-700">Satisfaction Rate</div>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      {/* Features Section */}
      <section id="features" className="py-20 px-4 bg-white/70 backdrop-blur-sm">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-civic-blue-900 mb-4">Powerful Features for Everyone</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div>
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-civic-blue-900">For Citizens</h3>
              </div>
                ...
                <Card className="border-civic-blue-200 hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <CardTitle className="text-civic-blue-900">Easy Issue Reporting</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <CardDescription>
                      Capture photos, add descriptions, and pinpoint exact locations with our intuitive mobile interface.
                    </CardDescription>
                  </CardContent>
                </Card>
                ...
                <Card className="border-civic-green-200 hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <CardTitle className="text-civic-green-900">Real-time Notifications</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <CardDescription>
                      Get instant updates when your report is received, assigned, and resolved.
                    </CardDescription>
                  </CardContent>
                </Card>
                ...
                <Card className="border-civic-orange-200 hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <CardTitle className="text-civic-orange-900">Progress Tracking</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <CardDescription>
                      Monitor the status of your reports and see exactly what's being done to address them.
                    </CardDescription>
                  </CardContent>
                </Card>
              </div>
            ...
            <div>
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-civic-green-900">For Municipal Staff</h3>
              </div>
              <div className="grid gap-6">
                <Card className="border-civic-green-200 hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <CardTitle className="text-civic-green-900">Smart Assignment</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <CardDescription>
                      Automated routing assigns issues to the right departments based on category and location.
                    </CardDescription>
                  </CardContent>
                </Card>
                ...
                <Card className="border-civic-blue-200 hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <CardTitle className="text-civic-blue-900">Priority Management</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <CardDescription>
                      Filter and prioritize issues by urgency, location, and available resources.
                    </CardDescription>
                  </CardContent>
                </Card>
                ...
                <Card className="border-civic-orange-200 hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <CardTitle className="text-civic-orange-900">Status Updates</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <CardDescription>
                      Keep citizens informed with real-time status updates and completion photos.
                    </CardDescription>
                  </CardContent>
                </Card>
              </div>
      ...
      <section id="how-it-works" className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-civic-blue-900 mb-4">How It Works</h2>
            <p className="text-xl text-civic-blue-700 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-civic-blue-900 mb-4">1. Report</h3>
              <p className="text-civic-blue-700">
                Snap a photo of the issue, add a description, and share your location. Our mobile app makes reporting quick and easy.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-civic-green-900 mb-4">2. Track</h3>
              <p className="text-civic-green-700">
                Watch as your report moves through the system. Get notifications when it's assigned, in progress, and completed.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-civic-orange-900 mb-4">3. Resolve</h3>
              <p className="text-civic-orange-700">
                See the issue resolved and receive before/after photos. Rate your experience and help improve city services.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-civic-blue-900 text-white py-12 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-blue-200">
                ...
                <li><a href="#" className="hover:text-white">Track Reports</a></li>
          ...
          <div className="border-t border-civic-blue-800 mt-8 pt-8 text-center text-sm text-blue-200">
            © 2024 CivicConnect. All rights reserved. Built for transparent governance.
          </div>
        </div>
      </footer>
    </div>
