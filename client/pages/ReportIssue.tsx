...
export default function ReportIssue() {
  ...
  const urgencyLevels = [
    { value: "low", label: "Low Priority", color: "civic-green-500", description: "Can wait a few weeks" },
    { value: "medium", label: "Medium Priority", color: "civic-orange-500", description: "Should be addressed soon" },
    { value: "high", label: "High Priority", color: "civic-orange-600", description: "Needs immediate attention" },
    { value: "urgent", label: "Urgent", color: "red-500", description: "Emergency situation" }
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-civic-green-50 via-white to-civic-blue-50 flex items-center justify-center p-4">
        <Card className="w-full max-w-md text-center">
          <CardHeader>
            ...
            <CardTitle className="text-2xl text-civic-green-900">Report Submitted!</CardTitle>
            <CardDescription>Your report has been received and assigned ID #CR-2024-0156</CardDescription>
          </CardHeader>
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between text-sm text-civic-blue-600">
            <span className={step >= 1 ? "font-semibold" : ""}>Category & Details</span>
            <span className={step >= 2 ? "font-semibold" : ""}>Location & Photos</span>
            <span className={step >= 3 ? "font-semibold" : ""}>Review & Submit</span>
          </div>
        </div>
        ...
        {step === 1 && (
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl text-civic-blue-900">What kind of issue are you reporting?</CardTitle>
              <CardDescription>
                Select the category that best describes your issue and provide details.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                <Label htmlFor="category" className="text-base font-semibold mb-3 block">Issue Category</Label>
                    ...
                    >
                      <CardContent className="p-4">
                        <div className="flex items-center gap-2 mb-1">
                          <div className={`w-3 h-3 rounded-full bg-${level.color}`}></div>
        ...
        {step === 2 && (
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl text-civic-blue-900">Where is this issue located?</CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <Label className="text-base font-semibold mb-3 block">Photos (Optional)</Label>
                ...
                {formData.photos.length > 0 && (
                  <div className="mt-4">
                    <p className="text-sm font-medium mb-2">{formData.photos.length} photo(s) selected:</p>
        ...
        {step === 3 && (
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl text-civic-blue-900">Review Your Report</CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-4">
                ...
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <Badge className={`bg-${urgencyLevels.find(u => u.value === formData.urgency)?.color}`}>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-civic-blue-700">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-xs">
                      <li>Your report will be automatically assigned to the appropriate department</li>
                      <li>You'll receive a confirmation notification with a tracking ID</li>
                      <li>Updates will be sent as the issue progresses through resolution</li>
                    </ul>
                  </div>
                </div>
              </div>
