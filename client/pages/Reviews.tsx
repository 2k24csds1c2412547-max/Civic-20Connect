        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div>
            ...
            <p className="text-sm text-civic-blue-600">
              Share your experience after resolution
            </p>
          </div>
          <Button asChild>
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl grid lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select your resolved report and rate the service
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 mt-1">
                {[1, 2, 3, 4, 5].map((s) => (
                  <button
                    key={s}
                    onClick={() => setRating(s)}
                    className={`w-9 h-9 ${rating >= s ? "text-yellow-500" : "text-gray-300"}`}
                  >
            ...
            <Button onClick={submit} disabled={!issueId || rating === 0}>
              Submit Review
            </Button>
          </CardContent>
        </Card>
